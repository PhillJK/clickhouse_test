		...
		for (let hour = 0; hour < hours; hour++) {
			for (let userIdx = 0; userIdx < 2; userIdx++) {
				for (let i = 0; i < 186; i++) {
					...
					const query =
						"INSERT INTO accounting (user, hotspot,session_id,end_at,input_bytes,input_packets,ip,nas,output_packets,output_bytes,session_time,start_at,user_ip,is_new)";
